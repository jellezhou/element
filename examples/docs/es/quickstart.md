...
```javascript
import Vue from 'vue';
import ElementUI from 'sale-element';
import 'sale-element/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'sale-element';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'sale-element';
