<template>
  ...
  >
    ...
    >
      ...
      >
        <span class="el-table__empty-text" style="margin-top:46px;border: 0">
          <img src="../../../examples/assets/images/noData.svg" alt="" />
          <div class="no-data">{{ emptyText || t('el.table.emptyText') }}</div>
        </span>
      </div>
      <div
        v-if="$slots.append"
