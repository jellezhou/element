...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'sale-element/src/utils/date-util';
  import { hasClass } from 'sale-element/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'sale-element/src/utils/util';
