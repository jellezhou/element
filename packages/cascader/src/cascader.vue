...
<script>
import Popper from 'sale-element/src/utils/vue-popper';
import Clickoutside from 'sale-element/src/utils/clickoutside';
import Emitter from 'sale-element/src/mixins/emitter';
import Locale from 'sale-element/src/mixins/locale';
import Migrating from 'sale-element/src/mixins/migrating';
import ElInput from 'sale-element/packages/input';
import ElTag from 'sale-element/packages/tag';
import ElScrollbar from 'sale-element/packages/scrollbar';
import ElCascaderPanel from 'sale-element/packages/cascader-panel';
import AriaUtils from 'sale-element/src/utils/aria-utils';
import { t } from 'sale-element/src/locale';
import { isEqual, isEmpty, kebabCase } from 'sale-element/src/utils/util';
import { isUndefined, isFunction } from 'sale-element/src/utils/types';
import { isDef } from 'sale-element/src/utils/shared';
